...
public class ProjectSeed
{
    ...
    private readonly GameEntity _defaultEntity = new()
    {
        Address = "Ставрополь",
    ...
    {
        GameClubs = new List<GameEntity>(1),
    ...
    public async Task SeedAsync()
    {
        ...
        _defaultUser.GameClubs = new List<GameEntity>(1) { _defaultEntity };
        
        _defaultEntity.Users = new List<User>(1) { _defaultUser };
